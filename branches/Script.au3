...
#AutoIt3Wrapper_Res_LegalCopyright=©Gajjar Tejas 2013
#AutoIt3Wrapper_Res_requestedExecutionLevel=highestAvailable
#AutoIt3Wrapper_Res_File_Add=wintop.jpg, rt_rcdata, wintop
...
$Button_Browse = GUICtrlCreateButton("Browse", 305, 14, 75, 25, $BS_SPLITBUTTON)
...
Func About()
	...
	$Child_Copyright = GUICtrlCreateLabel("Copyright (c) 2012 Gajjar Tejas", 56, 57, 149, 17)
	...
	$Child_Label_Website_ = GUICtrlCreateLabel("http://www.gajjartejas26.blogspot.com", 77, 110, 187, 17)
	GUICtrlSetFont(-1, 8, 400, 4, "MS Sans Serif")
	GUICtrlSetColor(-1, 0x0000FF)
	GUICtrlSetCursor(-1, 0)
